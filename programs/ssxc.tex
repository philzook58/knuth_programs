...
\N{1}{1}Intro. This program is an ``exact cover solver'' that I'm writing
...
has two fields, \PB{\\{itm}} and \PB{\\{loc}}. If \PB{$\|x\Z\|q<\|x+\|s$}, let %
\PB{$\|y\K\\{set}[\|q]$}.
...
\&{int} \\{loc};\C{ where this node resides in \PB{\|x}'s active set }\2\6
${}\}{}$ \&{node};\par
\A9.
\U2.\fi
...
\M{16}\B\X16:Input the options\X${}\E{}$\6
\&{while} (\T{1})\5
${}\{{}$\1\6
\&{if} ${}(\R\\{fgets}(\\{buf},\39\\{bufsize},\39\\{stdin})){}$\1\5
\&{break};\2\6
...
\M{22}The ``number of entries'' includes spacers (because {\mc DLX1}
...
\X33:Set \PB{\\{best\_itm}} to the best item for branching\X;\6
\&{if} ${}(\|t\E\T{0}){}$\1\5
...
\&{if} ${}(\\{active}\E\T{0}){}$\1\5
\X34:Visit a solution and \PB{\&{goto} \\{recover}}\X;\2\6
\&{if} ${}(\PP\\{level}>\\{maxl}){}$\5
${}\{{}$\1\6
...
${}\\{rr}\PP){}$\1\5
\X28:Remove the option \PB{\\{set}[\\{rr}]} from the other sets it's in\X;\2\6
\4${}\}{}$\2\par
\fi

\M{28}\B\X28:Remove the option \PB{\\{set}[\\{rr}]} from the other sets it's in%
\X${}\E{}$\6
${}\{{}$\1\6
...
\&{for} ${}(\|o,\39\\{rr}\K\|c,\39\|s\K\|c+\\{size}(\|c);{}$ ${}\\{rr}<\|s;{}$
${}\\{rr}\PP){}$\1\5
\X30:Unremove the option \PB{\\{set}[\\{rr}]} from the other sets it was in\X;%
\2\6
${}\|o,\39\|k\K\\{pos}(\|c);{}$\6
\&{if} ${}(\|k<\\{second}){}$\1\5
${}\\{active}\PP;{}$\2\6
...
\M{30}\B\X30:Unremove the option \PB{\\{set}[\\{rr}]} from the other sets it
was in\X${}\E{}$\6
${}\{{}$\1\6
\&{for} ${}(\|o,\39\\{tt}\K\\{set}[\\{rr}],\39\\{nn}\K\\{tt}+\T{1};{}$ ${}%
\\{nn}\I\\{tt};{}$ \,)\5
...
\M{33}The ``best item'' is considered to be an item that minimizes the
...
\Y\B\4\X33:Set \PB{\\{best\_itm}} to the best item for branching\X${}\E{}$\6
$\|t\K\\{max\_nodes};{}$\6
...
\M{34}\B\X34:Visit a solution and \PB{\&{goto} \\{recover}}\X${}\E{}$\6
${}\{{}$\1\6
...
\\{fflush}(\\{shape\_file});\6
\4${}\}{}$\2\6
\X35:Record solution and \PB{\&{goto} \\{recover}}\X;\6
\4${}\}{}$\2\par
\U24.\fi

\M{35}\B\X35:Record solution and \PB{\&{goto} \\{recover}}\X${}\E{}$\6
${}\{{}$\1\6
${}\\{count}\PP;{}$\6
...
\M{36}\B\X10:Subroutines\X${}\mathrel+\E{}$\6
...
\M{37}During a long run, it's helpful to have some way to measure progress.
...
\M{38}\B\X38:Print the profile\X${}\E{}$\6
${}\{{}$\1\6
