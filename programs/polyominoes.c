...
/*:7*/
#line 59 "./polyominoes.w"

/*3:*/
#line 95 "./polyominoes.w"
...
;
/*5:*/
#line 112 "./polyominoes.w"

if(!fgets(buf,buf_size,stdin))panic("No piece names");
printf(" %s",buf);

/*:5*/
#line 67 "./polyominoes.w"
;
/*6:*/
#line 116 "./polyominoes.w"
...
/*8:*/
#line 158 "./polyominoes.w"

while(t){
for(k= 1;k<=4;k++){
if(k<=s)/*11:*/
#line 185 "./polyominoes.w"
...
/*:11*/
#line 161 "./polyominoes.w"
;
/*10:*/
#line 177 "./polyominoes.w"
...
/*:9*/
#line 164 "./polyominoes.w"
;
t--;
}

/*:8*/
#line 149 "./polyominoes.w"
;
}

/*:6*/
#line 68 "./polyominoes.w"
;
}
