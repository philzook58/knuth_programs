...
;
/*9:*/
#line 333 "./celtic-paths.w"

inout[0][0][0]= -1;
for(s= 0;s>=0;){
pop(i,j,k);
/*10:*/
#line 343 "./celtic-paths.w"
...
/*:12*/
#line 353 "./celtic-paths.w"
;

/*:10*/
#line 337 "./celtic-paths.w"
;
}

/*:9*/
#line 126 "./celtic-paths.w"
;
/*13:*/
#line 414 "./celtic-paths.w"

/*14:*/
#line 419 "./celtic-paths.w"
...
;
for(i= 0;i<m;i++)/*16:*/
#line 432 "./celtic-paths.w"

{
s= 0;
for(j= 0;j<n;j++)/*17:*/
#line 439 "./celtic-paths.w"

{
kk= codetable[a[i][j]];
ii= bw[i][j][0];
if(kk>=0100)/*21:*/
#line 487 "./celtic-paths.w"
...
/*:20*/
#line 445 "./celtic-paths.w"

else/*19:*/
#line 461 "./celtic-paths.w"
...
/*:17*/
#line 435 "./celtic-paths.w"
;
printf("\n");
}

/*:16*/
#line 416 "./celtic-paths.w"
;
/*15:*/
#line 429 "./celtic-paths.w"
