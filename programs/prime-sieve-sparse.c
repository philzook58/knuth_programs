...
unsigned int plist[qsize][lsize];
unsigned int slist[qsize][lsize];
int count[qsize];
int countmax;
...
/*:24*/
#line 130 "./prime-sieve-sparse.w"
;
/*3:*/
#line 140 "./prime-sieve-sparse.w"
...
;
/*7:*/
#line 264 "./prime-sieve-sparse.w"

/*5:*/
#line 231 "./prime-sieve-sparse.w"
...
/*:9*/
#line 278 "./prime-sieve-sparse.w"
;
/*10:*/
#line 298 "./prime-sieve-sparse.w"
...
/*11:*/
#line 317 "./prime-sieve-sparse.w"

for(j= k= 0;k<count[qq];k++){
if(slist[qq][k]>=(qq+1)*ddel)
